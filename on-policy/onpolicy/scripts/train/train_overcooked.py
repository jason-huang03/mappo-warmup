...
def make_train_env(all_args):
    def get_env_fn(rank):
        def init_env():
            if all_args.num_reward_shaping_steps > 0:
...
def parse_args(args, parser):
    parser.add_argument(
        ...
        type=str,
        default="scenario2",
        help="Which overcooked scenario to run on",
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=1000,
        help="max length of episodes in the environment",
    )
    parser.add_argument(
        "--use_sparse_reward",
        action="store_true",
        default=False,
        help="use sparse reward",
    )

    parser.add_argument(
        "--num_reward_shaping_steps",
        type=int,
        default=0,
