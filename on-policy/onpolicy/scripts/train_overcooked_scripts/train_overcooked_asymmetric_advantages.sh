#!/bin/sh
env="overcooked"
scenario="asymmetric_advantages"
num_agents=2
...
do
    ...
    --ppo_epoch 15 --gain 0.01 --lr 7e-4 --critic_lr 7e-4 --wandb_name "xxx" --user_name "jason-huang03" --use_eval --n_eval_rollout_threads 20 --eval_interval 5 --use_sparse_reward
done